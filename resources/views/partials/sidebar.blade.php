<div class="dlabnav">
    <div class="dlabnav-scroll">
        <ul class="metismenu" id="menu">
            ...
            @canany(['companies.view','form-owners.view','maktab-categories.view','packages.view','care-offs.view','room-types.view','mehram-relations.view','waris-relations.view','cities.view','airlines.view','airports.view'])
            <li>
                <a class="has-arrow" href="javascript:void()" aria-expanded="false">
            ...
            @canany(['countries.view','currencies.view','hotels.view','transporters.view','guides.view','vendors.view','taxes.view'])
            <li>
                <a class="has-arrow" href="javascript:void()" aria-expanded="false">
